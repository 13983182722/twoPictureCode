...
public class ZXingCode {
	...
	private String saveFilePath = "F://img";
	private static String logoFilePath = "D:/111.png";
	...
	public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName) {
		try {
			...
			ImageIO.write(image, "png", new File(saveFilePath + "/TDC-" + new Date().getTime() + "test.png")); // TODO
